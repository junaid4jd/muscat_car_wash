      ...
      body: SingleChildScrollView(
          ...
          children: [
            ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                fit: BoxFit.cover,
                imageUrl:  widget.serviceImage.toString(),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'Service Name : '+widget.serviceName.toString(),
                      style: TextStyle(
                          fontSize: 18,
                  ...
                  //           if (await canLaunch('whatsapp://send?phone=${923314257676}')) {
                  //             await launch('whatsapp://send?phone=${923314257676}');
                  //           }
                  //           else {
                  //
                  //             Utils.flushBarErrorMessage('Sorry could not launch', context, AppColors.darkRedColor, 'Error', 2);
                  //
            ...
            widget.status == 'bookUser' ? Container() :
            Column(children: [
            ...
            widget.status == "Cancelled" || widget.status == "Confirmed" || widget.status == "Pending" ?
        ...
        Container(
          ...
          child: Padding(
            ...
            widget.status == "Confirmed" && userType == "Users" ?
            Column(
              children: [
                Container(
                  width: size.width * .95,
            ...
            widget.status == "Cancelled" || widget.status == "Confirmed" || widget.status == "Pending" ?  Container() :
            Container(
              width: size.width * .95,
              decoration: BoxDecoration(
                  color: Colors.white, borderRadius: BorderRadius.circular(8)),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                            ...
                            if (_site.toString() ==
                              ...
                              if (_cardUserControler.text.isEmpty) {
                                ...
                                FirebaseFirestore.instance
                                  ...
                                  "ServiceImage": widget.serviceImage.toString(),
                                  "address":   "address",
                                  ...
                                  Utils.flushBarErrorMessage("Successfully Booked", context, AppColors.greenColor, 'Success', 2);
                        ...
                        style: ElevatedButton.styleFrom(
                          primary: AppColors.lightBlueColor2,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                    ...
                    if (_site.toString() ==
                      ...
                      if (_cardUserControler.text.isEmpty) {
                        ...
                        FirebaseFirestore.instance
                          ...
                          Utils.flushBarErrorMessage("Successfully Paid", context, AppColors.greenColor, 'Success', 2);
                      ...
                      FirebaseFirestore.instance
                        ...
                        //   ),
                        // );
                        Utils.flushBarErrorMessage("Payment will be paid by cash", context, AppColors.greenColor, 'Success', 2);
                  ...
                  child: Text("Pay Now", style: subtitleWhite)),
            ) : Container(),
