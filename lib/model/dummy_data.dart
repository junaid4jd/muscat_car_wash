...
import 'package:muscat_car_wash/model/car_repair_service_model.dart';
import 'package:muscat_car_wash/model/month_model.dart';
import 'package:muscat_car_wash/model/settings_model.dart';
...
class DummyData {
  ...
  static  List<SettingsModel> settingList = [
    SettingsModel(name: 'Edit Profile', isIcon: true, icon: Icon(Icons.edit,size: 20,color: AppColors.lightBlueColor,), image: ''),
    SettingsModel(name: 'Feedback', isIcon: true, icon: Icon(Icons.feedback_outlined,size: 20,color: AppColors.lightBlueColor,), image: ''),
    SettingsModel(name: 'Logout', isIcon: true, icon: Icon(Icons.logout,size: 20,color:AppColors.lightBlueColor,), image: ''),
  ];
