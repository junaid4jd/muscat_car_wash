...
void main() async {
  ...
  if (Firebase.apps.length == 0) {
    ...
    if (Platform.isIOS) {
      ...
      await Firebase.initializeApp(
          options: FirebaseOptions(apiKey: 'AIzaSyDunOTHxlsMHqgSyY3CttCJTLAaxq7YxUM',
            appId: '1:578659559078:android:9715417f420ac7df89b667',
            messagingSenderId: '578659559078',
            projectId: 'muscat-car-wash',
            storageBucket:  "muscat-car-wash.appspot.com",
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      userType == 'Owner' ? CarOwnerHomeScreen() :
